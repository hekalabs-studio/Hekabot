...
// Konversi derajat arah angin ke mata angin singkat (16 arah).
// BUG SEBELUMNYA: array `directions` di bawah ini ada yang KEMBAR ("SBD" nongol 2x di index
// berbeda, buat 2 arah angin yang beda 45 derajat) + beberapa singkatan yang gak standar
// ("TM", "BLD", "BBU" -- bukan singkatan mata angin Indonesia yang dikenal). Efeknya, arah
// angin yang ditampilkan ke user bisa salah/ambigu (dua arah angin yang jauh beda kelihatan
// sama-sama "SBD"). Diperbaiki jadi 16 mata angin standar, urut sesuai derajat 0-337.5.
